...
var hamstringsImgs = ["Hamstring Smash", "https://image.ibb.co/cYup85/banded_hamstring_stretch.jpg", "Banded https://image.ibb.co/dAANd5/posterior_chain_floss.jpg", "https://image.ibb.co/hogrMQ/high_ball_smash.jpg"];
...
function startTimer(duration, display) {
    ...
    function timer() {
        ...
        if (diff <= 0) {
            ...
            // start = Date.now() + 1000;
          alert("Done With Exercise. Press OK to start timer again.");
          start = Date.now() + 1000;
        } 
    };
